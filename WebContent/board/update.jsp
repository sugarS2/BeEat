			...
			<div id="content">
				<div class="content-border">
					<center>
						...
						<form name="insert-form" class="insert-form" id="insert-form" method="post" enctype="multipart/form-data" action="./board.do?method=update&b_code=${updateForm.b_code}">
							<table class="insert-table">
								<tr>
									<th>제목</th>
									<td><input type="text" name="b_title" id="b_title" class="b_title" value="${updateForm.b_title}"/></td>
								</tr>
								<tr>
									<th>업종</th> 
									<td>
								...
								<tr>
									<th>내용</th> 
									<td>
										<textarea name="b_content" id="b_content" class="b_content">${updateForm.b_content}</textarea>
									</td>
								</tr>
								<tr>
									<th>대표 이미지1</th> 
								...
								<tr>
									<th>작성자</th> 
									<td>
										<input type="text" name="email" id="email" class="email" value="${updateForm.email}" readonly />
									</td>
								</tr>
								<tr>
