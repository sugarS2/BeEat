...
public class BoardSQL {
	static final String FIND_ALL = "SELECT b_code, b_title, c_code, b_content, b_img1, b_img2, b_img3, b_date, b_readnum, email FROM BOARD ORDER BY b_code desc";
	...
	static final String INSERT_REPLY = "INSERT INTO B_REPLY VALUES(B_REPLY_SEQ.nextval, ?, SYSDATE, B_REPLY_REFER_SEQ.nextval, 0, 0, ?, ?)";
